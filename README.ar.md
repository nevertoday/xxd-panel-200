...
# XXD Panel 200｜مشهد خطي أحادي بالرمادي المزرق
...
مشهد خطي أحادي بالرمادي المزرق
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-200`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-200 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-200-prompt.en.md) أو [بالصينية](references/xxd-panel-200-prompt.zh-CN.md).
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 200 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
