...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 200 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 200 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 200 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 200 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 200 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 200 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 200 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 200 新增上下样张 4"></td>
  </tr>
</table>
...
整体呈现**单色线描、小尺度图形、大面积留白、手绘草图痕迹与安静编辑排版**共同构成的视觉效果，像独立出版物、插画手账或艺术概念页中的 spot illustration：轻盈、克制、敏锐、诗意、有余韵。
...
安装后重新启动 Agent 会话，然后调用 `$xxd-panel-200`。也可以按需追加 `--global --agent codex --yes` 做用户级安装。

常用调用示例：

```text
/xxd-panel-200 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale zh-CN
...
完整运行契约见 [SKILL.md](SKILL.md)；运行适配器见 [英文](references/xxd-panel-200-prompt.en.md) 与 [中文](references/xxd-panel-200-prompt.zh-CN.md)。
...
- `design-only`：整张画布只呈现 Panel 200 的设计转译，照片只作为不可见参考。
