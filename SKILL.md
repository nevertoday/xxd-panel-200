---
name: xxd-panel-200
description: "Create Panel 200 raster artwork: Blue-grey Monochrome Line Vignette. Use when the user invokes xxd-panel-200 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-200/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-200-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
