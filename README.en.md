...
# XXD Panel 200｜Blue-grey Monochrome Line Vignette
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 200 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 200 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 200 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 200 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 200 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 200 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 200 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 200 additional top-bottom sample 4"></td>
  </tr>
</table>
...
Blue-grey Monochrome Line Vignette
...
- `design-only`: the full canvas contains only Panel 200's designed translation; the photograph remains a non-visible reference.
...
```bash
npx skills add https://github.com/nevertoday/xxd-panel-200 --skill xxd-panel-200
```

Restart the agent session after installation, then invoke `$xxd-panel-200`. Add `--global --agent codex --yes` when a user-level Codex installation is wanted.

Common examples:

```text
/xxd-panel-200 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale en-US
/xxd-panel-200 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-200 photo.jpg --mode design-only --size 9:16 --text none --prefs off
/xxd-panel-200 ./photos --mode design-only --size auto,3:4 --text prompt --locale ja-JP
```

See [SKILL.md](SKILL.md) for the full runtime contract and the [English](references/xxd-panel-200-prompt.en.md) or [Chinese](references/xxd-panel-200-prompt.zh-CN.md) runtime adapter.
